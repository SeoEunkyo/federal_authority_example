...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-3.0.22.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
exec "$JAVA" -client $JAVA_OPTS $ORIENTDB_OPTS_MEMORY $ORIENTDB_SETTINGS $SSL_OPTS \
    -Dfile.encoding=utf-8 -Dorientdb.build.number="3.0.x@r8afc634a2ea9c351898ae57dee8d739ff4851252; 2019-07-16 11:02:50+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-tools-3.0.22.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
